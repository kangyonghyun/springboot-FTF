package com.tennisFriends.modules.event.validator;

import com.tennisFriends.modules.event.Event;
import com.tennisFriends.modules.event.form.EventForm;
...
public class EventValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (isNotValidEndDateTime(eventForm)) {
            errors.rejectValue("endDateTime", "wrong,datetime", "모임 죵료 일시를 정확히 입력하세요.");
        }
